...
const BOTNAME = 'Joshtech|-WA-BOT™';
const FOOTERNAME = '> JoshCyber -  ＭＤ - Ｖ4';
global.owner = process.env.OWNER_NUMBER  || '55626129193' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=qc0THSCC#NI2h4QljacthMQw91bISdoi9lANasggh5NaXJE2lXF4' ,
...
FOOTER: process.env.FOOTER || '‌👨‍💻 JOSH -  ＭＤ - Ｖ5 👨‍💻',    
